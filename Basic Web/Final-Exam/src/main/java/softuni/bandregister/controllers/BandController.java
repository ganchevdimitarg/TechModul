...
public class BandController {
    ...
    public ModelAndView edit(ModelAndView modelAndView,
        ...
        Band bandEdit = this.bandRepository.findById(id).get();
        modelAndView.setViewName("base-layout");
        modelAndView.addObject("view", "band/edit");
        modelAndView.addObject("band", bandEdit);
    ...
    public ModelAndView delete(ModelAndView modelAndView,
        ...
        Band bandRemove = this.bandRepository.findById(id).get();
        modelAndView.setViewName("base-layout");
        modelAndView.addObject("view", "band/delete");
        modelAndView.addObject("band", bandRemove);
